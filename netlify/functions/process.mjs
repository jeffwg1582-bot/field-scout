...
export default async (req) => {
  ...
  const { image, mediaType = 'image/jpeg', note = '', scout = '', neighborhood = '', area = '', glat = null, glng = null } = b;
  ...
  const sub = { id, image, mediaType, note: note.trim(), scout, neighborhood, area, glat, glng, captured: new Date().toISOString() };
